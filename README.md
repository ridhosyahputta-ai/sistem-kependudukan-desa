...
MySQL Connector/NET
Cara Menjalankan
Import file db_kependudukan.sql ke MySQL (bisa lewat phpMyAdmin)
Buka project1_ridho.sln dengan Visual Studio
Sesuaikan connection string di Koneksi.cs kalau perlu
Build dan jalankan (F5)
Struktur Project
project1_ridho/
